...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/META-INF/Logo.png"))); // NOI18N
    ...
    String senha = txtsenha.getText(); // Captura a senha
    ...
    // Criamos o objeto funcionário com os dados digitados
    Funcionario funcionario = new Funcionario();
    funcionario.setCpf(login);
    funcionario.setSenha(senha); // Adicionado para validar a senha também

    // Chamada ao método que consulta o banco de dados
    ...
    if (funcionarioLogado != null) {
        ...
        TelaInicial t = new TelaInicial(funcionarioLogado);
        t.setVisible(true);
